...
namespace Stx.JP.Mobile.Views.Profile.Templates
{
    ...
    public partial class ResumeItemListTemplate : Grid
    {
        /// <summary>
        ...
        public static BindableProperty ParentBindingContextProperty =
         ...
         typeof(ResumeItemListTemplate), null);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResumeItemListTemplate"/> class.
        /// </summary>
		public ResumeItemListTemplate()
        {
            InitializeComponent();
        }
        ...
        /// Bindable property to set the child element.
        /// </summary>
        public static BindableProperty HeaderTypeProperty =
         BindableProperty.Create(nameof(HeaderType), typeof(object),
         typeof(ResumeItemListTemplate), null);
        ...
        {
            get { return GetValue(HeaderTypeProperty); }
